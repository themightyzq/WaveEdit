/*
  ==============================================================================
    ...
    CommandHandler_GetInfo.cpp
    WaveEdit - Professional Audio Editor
    Copyright (C) 2025 ZQ SFX

    Split out from CommandHandler.cpp under CLAUDE.md §7.5 (file-size cap).
    Hosts CommandHandler::getCommandInfo() — the giant per-command switch
    that fills in menu titles, descriptions, categories, default
    keypresses, and active state. CommandHandler.cpp keeps the
    constructor, getAllCommands, and the perform() dispatch.
